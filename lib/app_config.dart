...
class AppConfig {
  static String copyright_text =
      "@ Mackon Gh " + this_year; //this shows in the splash screen
  static String app_name = "Mackon Gh"; //this shows in the splash screen

  //configure this
  static const bool HTTPS = true;

  //configure this
  static const DOMAIN_PATH = "mtech.thedatech.com";
