...
main() async {
  ...
  fetch_user() async {
    ...
    if (userByTokenResponse.result == true) {
      ...
      UserId().value = userByTokenResponse.id;
      UserName().value = userByTokenResponse.name;
      UserEmail().value = userByTokenResponse.email;
      UserPhone().value = userByTokenResponse.phone;
      AvatarOriginal().value = userByTokenResponse.avatar_original;
    }
  }
